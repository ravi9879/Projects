...
export default function App() {  
    ...
    let array  = [[ 0,6,0,1,0,2,0,4,0 ],[  0,0,1,0,0,0,3,0,0],[ 0,2,5,8,0,9,1,6,0],[ 0,0,6,0,4,0,8,0,0],[ 0,1,0,0,0,0,0,3,0],[ 0,0,7,0,8,0,4,0,0],[ 0,4,8,3,0,7,6,1,0],[ 0,0,2,0,0,0,9,0,0], [0,5,0,9,0,6,0,8,0]] ;  

    const [solved_array , set_solved_array] = useState(array) ; 
    ...
    <button onClick={solve} >Solved Suduko</button>
